						...
						<div class="p-4 pl-6 mr-8 col-12 d-flex justify-content-center align-items-center row">
							...
							<div class="col-md-6">
							  ...
							  <div class="form-group">
                                   ...
                                   <select id="selectCountry" class="select2_multiple form-control @error('country') is-invalid @enderror">
								   </select>
							...
							<div class="col-md-6">
							  <div class="form-group">
								<label class=""><i class="fa fas fa-arrow-right arrow-icon"></i>{{ __('Ciudad') }}
@{{showSelectCity}}</label>

<div ng-show="showSelectCity">
						<select id="selectCity" class="select2_group form-control @error('email') is-invalid @enderror">
							<option value="">{{ __('Seleccione') }} </option>
                            <optgroup label="@{{dpt.name}}" ng-repeat="dpt in departments">
                              <option ng-repeat="city in dpt.cities" value="city.id">@{{city.name}}</option>
                            </optgroup>
                          </select>
</div>
<div ng-hide="showSelectCity===true">

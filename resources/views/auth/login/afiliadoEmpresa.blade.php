					...
					<div class="card-body">
						<form method="POST" action="{{ route('user.login','1') }}">
							...
							<div class="form-group">
								<input placeholder="Usuario" id="correo" type="email" class="form-control @error('correo') is-invalid @enderror" name="correo" value="{{ old('correo') }}" required autocomplete="correo" autofocus>

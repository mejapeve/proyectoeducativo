...
<div class="container">
	...
	<div class="pr-lg-2 col-12">
		...
		<div class="row ml-2">
			...
			<div class="col-auto ml-3 mt-3 mt-md-1">
	...
	<div class="pr-lg-2 col-lg-12 mt-3">
		...
		<div class="row p-3">
			...
			<div class="col-md-6 ml-md-6 mt-3 text-justify">
	...
	<div class="pr-lg-2 col-lg-12 mt-3">
		...
		<div class="row">
			...
			<div class="col-2-3  text-align">
				<img class="cursor-pointer" width="60" height="60" src="{{ asset('images/icons/preguntaCentral.png') }}">
				<p class="fs--1 p-3 " >Pregunta Central</p>
				<div class="panel-icon-pedagogy fs--3">
					
					<div class="header"><div class="panel-icon-up"></div><span>Pregunta central</span></div>
					<div class="body">
			...
			<div class="col-2-3  text-align">
				<img class="" width="60" height="60" src="{{ asset('images/icons/eCientifica.png') }}">
				<p class="fs--1 p-3">Experiencia científica</p>
			</div>
			<div class="col-2-3  text-align">

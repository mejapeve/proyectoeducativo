...
<div class="no-gutters row">
   <div class="pl-lg-2 mb-3 col-lg-5">
...
<div class="no-gutters row">
   <div class="pr-lg-2 mb-3 col-lg-6">
      ...
      <div class="about-body">
         orem ipsum dolor sit amet, consectetur adipiscing elit. Cras
         tempus euismod scelerisque. Suspendisse diam ante, elementum
         ac pharetra vitae, molestie a ipsum. Vestibulum et nisl dui. Suspendisse posuere nisi sit amet nulla
      </div>
   </div>
   <div class="pl-lg-2 mb-3 col-lg-6">
      <img class="img-thumbnail img-fluid mb-3 shadow-sm" src="{{ asset('images/welcome/swiper-container/swiper-container-2.png') }}" alt="">

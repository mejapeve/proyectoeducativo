                ...
                @for($i = 1; $i < 5 ; $i++)
                    @if($i ===1)
                        <svg class="svgelem2" width="10" height="20px" style="margin-right: -23px; margin-left: -18px;">
                            <rect width="35" fill="red" stroke="red" height="1" style="stroke-width:0.5;" />
                        </svg>
                    @else
                        <svg class="svgelem2" width="10" height="20px" style="margin-right: -26px;">
                            <rect width="12" fill="red" stroke="red" height="1" style="stroke-width:0.5;" />
                        </svg>
                    @endif
                    <svg class="svgelem"  width="35px" height="40px" style="margin-right:-10px" xmlns="http://www.w3.org/2000/svg">
                        <circle class="circle{{$j}}{{$i}}" cx="25" cy="25" r="5" fill="#FFFFFF" stroke="red"
                                stroke-width="2%"/>
                    </svg>
                @endfor
                <svg class="svgelem2" width="14px" height="20px" style="margin-right: -21px">
                    <rect width="35" height="1" fill="red" stroke="red" style="stroke-width:0.5;" />
                </svg>
                <svg width="50" height="80" xmlns="http://www.w3.org/2000/svg">
                        <path  class="star{{$j}}" fill="#FFFFFF"  style="transform:translate(12px, 22px) scale(.22,.22) rotate(-1deg);" stroke="red" stroke-width="6"
                        ...
                        <text class="number{{$j}}" x="50%" y="50%" text-anchor="middle" stroke="red" stroke-width="1.5px" dy=".18em" dx=".15em" style="text-anchor: middle;">{{$j}}</text>
                </svg>
            @endfor
        </div>
    </div>
                ...
                @for($i = 1; $i < 5 ; $i++)
                    @if($i ===1)
                        <svg class="svgelem2" width="10px" height="20px" style="margin-right: -21px; margin-left: -18px;">
                            <rect width="25" height="1"  fill="red" stroke="red" style="stroke-width:0.5;" />
                        </svg>
                    @else
                        <svg class="svgelem2" width="10px" height="20px" style="margin-right: -24px;">
                            <rect width="44" height="1" fill="red" stroke="red" style="stroke-width:0.5;" />
                        </svg>
                    @endif
                    <svg class="svgelem"  width="33px" height="40px" style="margin-right:-12px" xmlns="http://www.w3.org/2000/svg">
                        <circle class="circle{{$j}}{{$i}}" cx="21" cy="25" r="4" fill="#FFFFFF" stroke="red"
                                stroke-width="2%"/>
                    </svg>
                @endfor
                <svg class="svgelem2" width="10px" height="20px" style="margin-right: -10px">
                    <rect width="16" height="1" fill="red" stroke="red" style="stroke-width:0.5;" />
                </svg>
                <svg width="50" height="80" xmlns="http://www.w3.org/2000/svg"  style="margin-left: -9px;">
                    <path  class="star{{$j}}" fill="#FFFFFF"  style="transform:translate(12px, 22px) scale(.22,.22) rotate(-1deg);" stroke="red" stroke-width="6"
                           d="m135.78 50.46c0-2.01-1.52-3.259-4.564-3.748l-40.897-5.947-18.331-37.07c-1.031-2.227-2.363-3.34-3.992-3.34-1.629
                              ...
                              1.916-.392 2.486-1.181.569-.788.854-1.752.854-2.893 0-.706-.027-1.249-.082-1.63l-7.01-40.736 29.574-28.841c1.414-1.412
                              2.119-2.716 2.119-3.911"/>
                    <text class="number{{$j}}" x="50%" y="53%" text-anchor="middle" stroke="red" stroke-width="1px" dy=".08em" dx=".05em" style="text-anchor: middle;">{{$j}}</text>
                </svg>
            @endfor
        </div>
    </div>

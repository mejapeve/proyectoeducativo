            ...
            @for($j = 1; $j < 9 ; $j++)
                @for($i = 1; $i < 5 ; $i++)
                    @if($i ===1)
                        <svg class="svgelem2" width="10px" height="20px" style="margin-right: -20px; margin-left: -18px;">
                            <rect width="25" height="1" style="fill:rgb(0,0,255);stroke-width:0.5;stroke:rgb(0,0,0)" />
                        </svg>
                    @else
                        <svg class="svgelem2" width="10px" height="20px" style="margin-right: -26px;">
                            <rect width="44" height="1" style="fill:rgb(0,0,255);stroke-width:0.5;stroke:rgb(0,0,0)" />
                        </svg>
                    @endif
                    <svg class="svgelem"  width="30px" height="40px" style="margin-right:-10px" xmlns="http://www.w3.org/2000/svg">
                        <circle id="circle{{$j}}{{$i+4}}" cx="21" cy="25" r="4" fill="#f1f1f1" stroke="green"
                                stroke-width="2%"/>
                    </svg>
                @endfor
                <svg class="svgelem2" width="10px" height="20px" style="margin-right: -10px">
                    <rect width="16" height="1" style="fill:rgb(0,0,255);stroke-width:0.5;stroke:rgb(0,0,0)" />
                </svg>
                <svg width="50" height="80" xmlns="http://www.w3.org/2000/svg"  style="margin-left: -9px;">
                        <path  id="star{{$j}}" fill="#f1f1f1"  style="transform:translate(12px, 22px) scale(.22,.22) rotate(-1deg);" stroke="black" stroke-width="6"
                              ...
                              1.916-.392 2.486-1.181.569-.788.854-1.752.854-2.893 0-.706-.027-1.249-.082-1.63l-7.01-40.736 29.574-28.841c1.414-1.412
                              2.119-2.716 2.119-3.911"/>
                        <text x="50%" y="53%" text-anchor="middle" stroke="#51c5cf" stroke-width="1px" dy=".08em" dx=".05em" style="text-anchor: middle;">{{$j}}</text>
                </svg>
            @endfor
        </div>
    </div>

...
@if(isset($moment))
    ...
    <div class="fs--2 font-weight-semi-bold">
        ...
        <a class="cursor-pointer d-flex" href="{{route('student.show_moment_section',['empresa'=>auth('afiliadoempresa')->user()->company_name(), 'sequence_id' => $sequence_id, 'moment_id' => $moment->id, 'section_id' => ($index+1)])}}">

               ...
               <div class="ScrollbarsCustom-Content" style="box-sizing: border-box; padding: 0.05px; min-height: 100%; min-width: 100%;">
				  ...
				  @auth('afiliadoempresa')
                     <li class="mt-1 nav-item">
					  ...
					  <li class="mt-1 nav-item">
						  <a class="my-3 btn btn-primary btn-sm btn-block" href="#">Notificaciones</a>						  
					  </li>
					  <li class="mt-1 nav-item">
						  <a class="my-3 btn btn-primary btn-sm btn-block" href="#">VerPerfil</a>						  
					  </li>
				  ...
				  @endauth
					  <li class="mt-1 nav-item">
						  <a class="my-3 btn btn-primary btn-sm btn-block" href="#">PQRS</a>						  
					  </li>
				  </ul>
               </div>
            </div>

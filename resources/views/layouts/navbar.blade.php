      ...
      @if(auth('afiliadoempresa')->user())
         ...
         <ul class="nav collapse navbar-collapse row text-align-rigth fs-lg-0 row">
            ...
            <li class="nav-item ml-lg-14 col-auto d-flex">
               <a href="{{ route('student.available_sequences',auth('afiliadoempresa')->user()->company_name()) }}" class="nav-link  mr-2 p-0 pb-1 @if(\Route::current()->getName() == 'student.available_sequences') selected @endif">Mis cursos</a><i class="fas fa-book-open fs-1"></i></li>
